...
public final class ShellUtils {
    ...
    public static Utils.Task<CommandResult> execCmdAsync(final String command,
                                                         final boolean waitForThread,
                                                         final boolean isRooted,
                                                         final Utils.Consumer<CommandResult> consumer) {
        return execCmdAsync(new String[]{command},waitForThread, isRooted, true, consumer);
    }
    ...
    public static Utils.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                         ...
                                                         final boolean isRooted,
                                                         final Utils.Consumer<CommandResult> consumer) {
        return execCmdAsync(commands == null ? null : commands.toArray(new String[]{}), waitForThread,isRooted, true, consumer);
    }
    ...
    public static Utils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                         ...
                                                         final boolean isRooted,
                                                         final Utils.Consumer<CommandResult> consumer) {
        return execCmdAsync(commands, waitForThread,isRooted, true, consumer);
    }
    ...
    public static Utils.Task<CommandResult> execCmdAsync(final String command,
                                                         ...
                                                         final Utils.Consumer<CommandResult> consumer) {
        return execCmdAsync(new String[]{command},waitForThread, isRooted, isNeedResultMsg, consumer);
    }
    ...
    public static Utils.Task<CommandResult> execCmdAsync(final String[] commands,
        ...
        return doAsync(new Utils.Task<CommandResult>(consumer) {
            @Override
            public CommandResult doInBackground() {
                return execCmd(commands, waitForThread,isRooted, isNeedResultMsg);
            }
        });
    }
     ...
     * @return the single {@link CommandResult} instance
     */
    public static CommandResult execCmd(final String command, final List<String> envp,
                                        final boolean waitForThread, final boolean isRooted) {
     ...
     * @return the single {@link CommandResult} instance
     */
    public static CommandResult execCmd(final String[] commands, final boolean waitForThread, final boolean isRooted) {
        return execCmd(commands, waitForThread, isRooted, true);
    }
    ...
    public static CommandResult execCmd(final String command,
                                        ...
                                        final boolean waitForThread,
                                        final boolean isNeedResultMsg) {
        return execCmd(new String[]{command}, waitForThread, isRooted, isNeedResultMsg);
    }
    ...
    public static CommandResult execCmd(final String command,
                                        ...
                                        final boolean isRooted,
                                        final boolean isNeedResultMsg) {
        return execCmd(new String[]{command}, envp, waitForThread, isRooted, isNeedResultMsg);
    }
    ...
    public static CommandResult execCmd(final String[] commands,
                                        ...
                                        final boolean isRooted,
                                        final boolean isNeedResultMsg) {
        return execCmd(commands, null, waitForThread, isRooted, isNeedResultMsg);
    }
